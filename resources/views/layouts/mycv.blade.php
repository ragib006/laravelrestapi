...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('mycv')}}/assets/images/fav.jpg">
    <link rel="stylesheet" href="{{asset('mycv')}}/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('mycv')}}/assets/css/fontawsom-all.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('mycv')}}/assets/css/style.css" />
</head>
                ...
                <div class="col-md-4 left-co">
                    ...
                    <div class="left-side">
                        <div class="profile-info">
                            <img src="{{asset('mycv')}}/assets/images/profile.jpg" alt="">
                        ...
                        --------------------->
                        <h4 class="ltitle">Personal Information</h4>

                        <div class="refer-cov">

                             <p style="margin-bottom:10px">
                            <span>Father's Name :<span>  <span>Rahamot Ullaha<span>
                              </p>


                                <p style="margin-bottom:10px">
                            <span>Mother's Name :<span>  <span>Rabeya Beguom<span>
                              </p>



                                <p style="margin-bottom:10px">
                            <span>Date Of Birth :<span>  <span>12-04-2011<span>
                              </p>


                            <p style="margin-bottom:10px">
                            <span>NID Number :<span>  <span>456547645754<span>
                              </p>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis accumsan purus enim, a vestibulum est tristique sit amet. Suspendisse nibh nisl, imperdiet sit amet mi vitae, elementum elementum nibh. Vivamus vitae eros malesuada, convallis dolor malesuada, lobortis ex. Sed cursus augue risus, ac semper est consectetur vitae. Praesent consequat metus sit amet rhoncus luctus.</p>
                        ...
                        <div class="work-exp">
                               ...
                               <p>
                                  ...
                                  <span>Job Position :</span>     <span>None</span>
                                 ...
                                 <p>
                                  ...
                                  <span>Job Experience :</span>     <span>None</span>
                                  ...
                                  <p style="font-weight:bold">Job Responsibility</p>     
                                  <span>malesuada, lobortis ex. Sed cursus augue risus, ac semper est consectetur vitae. Praesent consequat metus sit amet rhoncus luctus.</span>
                        ...
                        <div class="education">
                                 ...
                                 <p>
                                  ...
                                  <span>Education Level :</span>     <span>Bsc In CSE</span>
                                  ...
                                  <span>Degree Title :</span>     <span>Masters</span>
                                  ...
                                  <span>Mejor Subject :</span>     <span>Accounting</span>
                                  ...
                                  <span>Institution Name :</span>     <span>University Of Canada</span>

                                </p>

                                         <p>

                                  <span>Pass Year :</span>     <span>2022</span>
                        ...
                        <div class="profess-cover row no-margin">
                         ...
                         <span style="padding-bottom:50px">sdsvdf evvrevfe e3vbrev 3vedvevre 3eferv 3gfwed efwefwr</span>
...
<script src="{{asset('mycv')}}/assets/js/jquery-3.2.1.min.js"></script>
<script src="{{asset('mycv')}}/assets/js/popper.min.js"></script>
<script src="{{asset('mycv')}}/assets/js/bootstrap.min.js"></script>
<script src="{{asset('mycv')}}/assets/js/script.js"></script>
